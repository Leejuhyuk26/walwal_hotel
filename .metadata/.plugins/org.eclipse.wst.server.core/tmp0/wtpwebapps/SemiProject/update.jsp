	...
	<section class="conB">
		<div class="container">
			<form name="frm" action="updateOk.do" method="post"
				...
				<input type="hidden" name="num" value="<%=num%>"> 제목: <input
					type="text" name="subject" value="<%=subject%>"><br>
				<br> 평점:<br> <input type="radio" name="star" value="1"
					<%=astar%>>★☆☆☆☆<br> <input type="radio" name="star"
					value="2" <%=bstar%>>★★☆☆☆<br> <input type="radio"
					name="star" value="3" <%=cstar%>>★★★☆☆<br> <input
					type="radio" name="star" value="4" <%=dstar%>>★★★★☆<br>
				...
				<input type="hidden" name="c_num" value="<%=c_num%>"> <br>
