 ...
 * Generated at: 2020-11-13 12:30:55 UTC
...
public final class myinfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.lec.beans.CustomerDTO");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<form name=\"frm\" id=\"contact-form\" action=\"myinfo_update.do\" method=\"post\"\r\n");
      out.write("\t\t\t\tonsubmit=\"return chkSubmit()\">\r\n");
      out.write("\t\t\t\t<div id=\"content-header\">\r\n");
      out.write("\t\t\t\t\t<h3>내 정보관리</h3>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<label>ID : </label><input type=\"text\" id=\"login_id\" value=\"");
      out.print(c_id );
      out.write("\" readonly>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<label>PW :</label> <input type=\"password\" name=\"c_pw\"\r\n");
      out.write("\t\t\t\t\t\tplaceholder=\"비밀번호 재설정\" />\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<label>PW 확인 :</label> <input type=\"password\" name=\"c_pwchk\"\r\n");
      out.write("\t\t\t\t\t\tplaceholder=\"비밀번호 확인\" />\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<label>이름 :</label> <input type=\"text\" name=\"c_name\"\r\n");
      out.write("\t\t\t\t\t\tvalue=");
      out.print(c_name);
      ...
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<label>전화번호 :</label> <input type=\"text\" name=\"c_phone\"\r\n");
      out.write("\t\t\t\t\t\tvalue=");
      out.print(c_phone);
      out.write(" placeholder=");
      out.print(c_phone);
      ...
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<label>이메일 :</label> <input type=\"text\" name=\"c_email\"\r\n");
      out.write("\t\t\t\t\t\tvalue=");
      out.print(c_email);
      out.write(" placeholder=");
      out.print(c_email);
      out.write(" />\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<input type=\"submit\" id=\"logbtn\" class=\"hc vc\" value=\"수정하기\"/>\r\n");
      out.write("\t\t\t\t<input type=\"button\" class=\"hc vc\" value=\"회원탈퇴\" onClick=\"return test()\">\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("</section>\t\r\n");
      out.write("\t<!-- 푸터// -->\r\n");
      ...
      out.write("<script type=\"text/javascript\" src=\"JS/myinfo_update.js\"></script>\r\n");
      out.write("</html>");
